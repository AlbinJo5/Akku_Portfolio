...
const ModalMain = ({ modalId, setGetModal, modalData }) => {
  console.log(modalData);
  if (modalId === 1) {
    return (
      <ModalOne modalId={modalId} setGetModal={setGetModal} item={modalData} />
    );
  } else if (modalId === 2) {
    return (
    ...
    return (
      <ModalThree modalId={modalId} setGetModal={setGetModal} item={modalData} />
    );
  } else if (modalId === 4) {
    return (
